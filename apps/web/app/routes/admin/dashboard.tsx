    ...
    <div className="space-y-8">
      <section>
        ...
        <p className="mt-2 max-w-2xl text-sm text-slate-600">
          Use the admin portal to manage digital preservation workflows. Start a
          draft package, ingest new artifacts, or check fixity and storage
          locations.
        </p>
      </section>
      ...
      <section className="rounded-lg border border-slate-200 bg-slate-50 p-6">
        <h3 className="text-sm font-semibold uppercase tracking-wide text-slate-700">
          Draft &rarr; Upload &rarr; Confirm Flow
        </h3>
        <ol className="mt-4 space-y-3 text-sm text-slate-700">
          <li>
            <span className="font-semibold text-slate-900">1. Create Draft:</span>{" "}
            Start a new archival package draft to reserve paths and capture
            metadata.
          </li>
          <li>
            <span className="font-semibold text-slate-900">2. Upload:</span> Use
            the provided Globus details to upload the package contents.
          </li>
          <li>
            <span className="font-semibold text-slate-900">3. Confirm:</span>{" "}
            Finalize the package to trigger verification and preservation events.
          </li>
        </ol>
      </section>
    </div>
